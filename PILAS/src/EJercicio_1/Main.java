...
En un puerto de carga, los contenedores se apilan en columnas verticales dentro de los barcos o en el muelle. Debido al espacio 
restringido, solo se puede acceder al contenedor que está en la cima.
...
Reto: Implementa un método contarPorEmpresa(String nombreEmpresa) que recorra la pila y devuelva la cantidad total de contenedores que 
pertenecen a esa empresa.*/
